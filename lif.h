...
int * sim(int N, int Nrecord, double T, int Nt, int Ne, int Ni, double q,
  ...
  static PyObject* lif(PyObject* Py_UNUSED(self), PyObject* args) {
    ...
    if (!PyArg_ParseTuple(args, "O!", &PyList_Type, &list))
      ...
      v = sim(N,Nrecord,T,Nt,Ne,Ni,q,dt,pee0,pei0,pie0,pii0,jee,jei,jie,jii,
    ...
    memcpy(PyArray_DATA(ret), Ix1e, Nt*sizeof(double));
    free(Ix1e);
